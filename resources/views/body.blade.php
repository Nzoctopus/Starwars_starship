...
<body>
    ...
    <div class="left-0 right-0 justify-center flex flex-wrap pt-5 pb-5">
        <a href="/starships/detail_custom_ship/create" class="text-white bg-gradient-to-bl from-black to-gray-800 hover:bg-gradient-to-b focus:ring-4 focus:outline-none focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">ADD Custom Starships</a>
        <a href="/starships/detail_satellite/create" class="text-white bg-gradient-to-bl from-black to-gray-800 hover:bg-gradient-to-b focus:ring-4 focus:outline-none focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">ADD Satellite</a>
