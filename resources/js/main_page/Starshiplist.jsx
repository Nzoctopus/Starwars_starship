...
export default function Starshiplist () {
    ...
    if (error) {
        return <div className="sm:text-5xl text-slate-400 font-bold">Nothing Found...</div>;
    }

    return (
        <div>
            <div className="sm:text-center pb-16">
            <p className="mt-6 text-[2.5rem] leading-none sm:text-4xl tracking-tight font-bold text-yellow-500">Starships</p>
