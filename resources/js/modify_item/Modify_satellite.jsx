...
import useModify_satellite from "./useModify_satellite";

export default function Modify_satellite ()
{
    const {fetchData, queryValue, handleChange, handleSubmit, fields, data} = useModify_satellite();
    ...
    return (
        <div className="inline-block">
            <h1 className="mt-6 text-[2.5rem] leading-none sm:text-4xl tracking-tight font-bold text-yellow-500 py-5 text-center">Modify Satellite</h1>
