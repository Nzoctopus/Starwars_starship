          ...
          {FetchedData.map((item, index) => (
            <details key={index}>
                ...
                <div className="flex flex-wrap gap-5 px-5">
                  ...
                  <button onClick={(e) => handleClick(e, `/starships/detail_satellite/${item.id}`)} className="text-white bg-gradient-to-bl from-black to-gray-800 hover:bg-gradient-to-b focus:ring-4 focus:outline-none focus:ring-yellow-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 self-center">Modify Satellite</button>
                </div>
            </details>
          ))}
    </div>
