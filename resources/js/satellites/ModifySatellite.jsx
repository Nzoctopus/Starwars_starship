...
export default function ModifySatellite ({data, setModifying, fetchData})
{
    ...
    const handleSubmit = async (e) => {
        ...
        setModifying(false);
        try {
            await axios.post('/modify/satellite', values);
        } catch (error) {
    ...
    return (
        <div className="inline-block">
            <h1 className="mt-6 text-[2.5rem] leading-none sm:text-4xl tracking-tight font-bold text-yellow-500 py-5 text-center">Modify Satellites</h1>
