...
export default function DetailCustomshipPage () {
    ...
    const SubmitLink = isCreating ? '/store/ship' : '/modify/customship';
    const FetchLink = `/api/custom/${params.id}`;
    const Title = isCreating ? 'ADD STARSHIP' : 'MODIFY STARSHIP'
    const {fields, data, setData, handleChange} = useCustomship();
    ...
    <div className="inline-block">
            ...
            <form onSubmit={(e) => handleSubmit(e, SubmitLink, '/starships/list_custom_ship', data)}>
