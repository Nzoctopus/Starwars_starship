...
export default function AddCustomshipPage () {

    const {fields, handleChange, handleSubmit} = useCustomship();

    return (
        <div className="inline-block">
            <h1 className="mt-6 text-[2.5rem] leading-none sm:text-4xl tracking-tight font-bold text-yellow-500 py-5 text-center">ADD STARSHIPS</h1>
